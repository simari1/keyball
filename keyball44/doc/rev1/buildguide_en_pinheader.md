...
The jumper is soldered on **【Back Side Only】**.
...
Mount all of them on the **【TOP SURFACE】**.
...
Alternatively, you can flash the downloaded `.hex` file with Pro Micro Web Updater: https://sekigon-gonnoc.github.io/promicro-web-updater/index.html
...
Insert the sensor IC from the **【BACK SIDE】** of the ball board where no electric components are mounted.
...
Next, attach the L-shaped spring-loaded 7pin headers to the right-hand board **【TOP FACE】**.  
...
Tighten the two M1.7 Torx screws with **【wide flat heads】** from the back of the body. Tighten the screws while holding the ball retainer case with your fingers to prevent it from rotating.
...
You can also flash the downloaded `.hex` file with Pro Micro Web Updater: https://sekigon-gonnoc.github.io/promicro-web-updater/index.html
